<?php $this->Html->script(SITE_URL.'/js/pages/forms-layouts.js', array('block' => 'scripts'));?>
            <div class="panel invoice-panel">
                ...
                <div class="panel-body p20" id="invoice-item">
                    ...
                    <div class="row mb30">
                        <div class="col-md-4">
                            <div class="pull-left">
                                <h5 class="mn"> Created: <?php echo date("d M Y", strtotime($order['Order']['created']));?> </h5>
                                <h5 class="mn"> Status:
                                    <b class="text-success"><?php if($order['Order']['status'] == 1){ echo "Done";}else if($order['Order']['status'] == 2){echo "Decline";}else{ echo "Pending";}?></b>
                                </h5>
                            </div>
                        </div>
                        <div class="col-md-4">
