...
<!--
			<div class="es_button">
-->
				<input class="sendButton" name="es_txt_button" id="es_txt_button" onClick="return es_submit_page('<?php echo $url; ?>',this)" value="<?php _e('SIGN UP >', 'email-subscribers'); ?>" type="button">
<!--
			</div>
-->
<!--
			<div class="es_textbox">
-->
				<input class="email-signup" style="float:right;" name="es_txt_email" id="es_txt_email" onkeypress="if(event.keyCode==13) es_submit_page('<?php echo $url; ?>',this)" value="" maxlength="225" value="Email Address" type="text">
<!--
			</div>
-->
            
            <span class="emailSignUpLabel"><?php _e('Email Sign Up', 'email-subscribers'); ?></span>
            
            <div class="success-msg"><span id="es_msg"></span></div>
