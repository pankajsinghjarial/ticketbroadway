...
function get_comment_reply_link( $args = array(), $comment = null, $post = null ) {
	...
	if ( get_option( 'comment_registration' ) && ! is_user_logged_in() ) {
		$link = sprintf( '<a rel="" class="comment-reply-login" href="%s">%s</a>',
		...
		$link = sprintf( "<a rel='' class='comment-reply-link' href='%s' onclick='%s' aria-label='%s'>%s</a>",
...
function get_post_reply_link($args = array(), $post = null) {
	...
	if ( get_option('comment_registration') && ! is_user_logged_in() ) {
		...
		$link = sprintf( "<a rel='' class='comment-reply-link' href='%s' onclick='%s'>%s</a>",
...
function get_cancel_comment_reply_link( $text = '' ) {
	...
	$formatted_link = '<a rel="" id="cancel-comment-reply-link" href="' . $link . '"' . $style . '>' . $text . '</a>';
	/**
